...
import 'package:granago_app/src/controllers/gasto_controller.dart'; // Importe o GastoController
...
class _EditGastoPageState extends State<EditGastoPage> {
  ...
  void initState() {
    ...
    _valorController = TextEditingController(
        text: widget.gasto.valor.toStringAsFixed(2).replaceAll('.', ','));
    _descricaoController = TextEditingController(text: widget.gasto.descricao);
    gastoDate = widget.gasto.data;
